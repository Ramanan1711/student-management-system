        ...
        student.id === selectedStudentId
          ? {
              ...
              fee: {
                ...student.fee,
                [field]: value,
                ...(field === "finalFee" || field === "amountPaid" || field === "courseFee" || field === "discount"
                  ? { pendingAmount: Math.max(0, (field === "finalFee" ? Number(value) : student.fee.finalFee) - (field === "amountPaid" ? Number(value) : student.fee.amountPaid)) }
                  : {}),
              },
            }
          : student,
