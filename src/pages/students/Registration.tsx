    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <input value={student.name} onChange={(event) => updateField("name", event.target.value)} placeholder="Student Name" className="rounded-lg border border-slate-200 px-3 py-2.5 text-sm" />
          <input value={student.mobile} onChange={(event) => updateField("mobile", event.target.value)} placeholder="Mobile" className="rounded-lg border border-slate-200 px-3 py-2.5 text-sm" />
          <input value={student.email} onChange={(event) => updateField("email", event.target.value)} placeholder="Email" type="email" className="rounded-lg border border-slate-200 px-3 py-2.5 text-sm" />
